  ...
  return (
    <div className={`mobile_header ${scrolled ? "background" : ""}`}>
      <div className="mh_content">
        ...
        <div
          className={`mh_toggle ${toggle ? "switch" : "delay"}`}
          onClick={toggleMenu}
        >
          ...
          <div className="mh_margin">
            ...
            <div className="mh_links">
              {HeaderLinksData.map((link, index) => (
                <NavLink className="mh_link" to={link.link} key={index}>
                  <GiKnifeFork />
            ...
            <div className="mh_media">
              <Link target="_blank" to={"#"} className="mh_media_link">
                <FaSquareInstagram />
              </Link>
              <Link
                to={
